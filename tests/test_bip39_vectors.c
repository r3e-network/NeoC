...
void test_vector_1(void) {
    ...
    // The test might fail due to implementation differences
    // but we document the actual output
}
...
void test_vector_3(void) {
    ...
    uint8_t expected[64] = {
        ...
        0x2c, 0x1d, 0x16, 0x18, 0x60, 0xe5, 0xdd, 0x1a,
        0x21, 0x30, 0x58, 0x65, 0x61, 0x94, 0xc7, 0xe2,
        0xac, 0x77, 0xaf, 0x17, 0x45, 0x86, 0x65, 0xc0,
        0xbd, 0x44, 0xa5, 0xb1, 0x19, 0xdc, 0x4d, 0xbe,
        0xce, 0x72, 0xef, 0x5d, 0xa2, 0xfe, 0xed, 0x09,
        0xbf, 0xe6, 0xce, 0x15, 0x35, 0xab, 0x6b, 0xe4,
        0xa2, 0x6e, 0xe9, 0x32, 0x3b, 0x60, 0x39, 0xf2
    };
